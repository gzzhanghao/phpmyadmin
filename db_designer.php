...
$scripts->addFile('pmd/column.js');
$scripts->addFile('pmd/e.js');
$scripts->addFile('pmd/page.js');
$scripts->addFile('pmd/relation.js');
$scripts->addFile('pmd/table.js');
$scripts->addFile('pmd/database.js');
